data <- read.table(file="/Users/renegirard7gfy/Desktop/Thrash_Lab/Mix/all_archaea.env_category.groups.rarefaction", header=T)
...
pdf(file="/Users/renegirard7gfy/Desktop/Arc_Uniq_5per_FixedYx.pdf")
...
points(data$X0.05.plant~data$numsampled, type="l", col="red", lwd=2)
points(data$X0.05.aerosol~data$numsampled, type="l", col="green", lwd=2)
points(data$X0.05.aquatic~data$numsampled, type="l", col="blue", lwd=2)
points(data$X0.05.built~data$numsampled, type="l", col="orange", lwd=2)
points(data$X0.05.other~data$numsampled, type="l", col="black", lwd=2)
points(data$X0.05.soil~data$numsampled, type="l", col="purple", lwd=2)
points(data$X0.05.zoonotic~data$numsampled, type="l", col="deeppink", lwd=2)

legend(x=15000, y=3250, lwd=2, lty=1,
