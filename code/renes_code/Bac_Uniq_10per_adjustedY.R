...
pdf(file="/Users/renegirard7gfy/Desktop/Bac_Uniq_10per.pdf")


par(mar=c(5,5,0.5,0.5))
plot(NA, type="n", ylim=c(0,max(10000)),
     xlim=c(0,max(data$numsampled)),
     xlab="Number of sequences sampled",
     ylab="",
     axes=FALSE)

points(data$X0.10.plant~data$numsampled, type="l", col="red", lwd=2)
points(data$X0.10.aerosol~data$numsampled, type="l", col="green", lwd=2)
points(data$X0.10.aquatic~data$numsampled, type="l", col="blue", lwd=2)
points(data$X0.10.built~data$numsampled, type="l", col="orange", lwd=2)
points(data$X0.10.other~data$numsampled, type="l", col="black", lwd=2)
points(data$X0.10.soil~data$numsampled, type="l", col="purple", lwd=2)
points(data$X0.10.zoonotic~data$numsampled, type="l", col="deeppink", lwd=2)

legend(x=5e5, y=8000, lwd=2, lty=1,
...
axis(2, at=seq(0,16000,2000), label=c("0", "2,000", "4,000", "6,000", "8,000", "10,000", "12,000", "14,000", "16,000"), las=2, cex.axis=0.8)
box()
