...
print(composite, include.rownames=FALSE, include.colnames=TRUE, hline.after = c(-1, nrow(composite)), comment=FALSE, add.to.row=addtorow, caption.placement = "top", size="scriptsize")
```
