...
archaea_sequences <- read.table(file="data/mothur/emirge.archaea.taxonomy")[1]
...
mothur "#set.dir(input=data/mothur, output=data/mothur);
        ...
        rarefaction.single(shared=all_archaea.all_categories.shared, outputdir=data/process)"
...
mothur "#set.dir(input=data/mothur, output=data/mothur);
        ...
        rarefaction.single(shared=all_archaea.pool_category.shared, outputdir=data/process)"
...
mothur "#set.dir(input=data/mothur, output=data/mothur);
        ...
        rarefaction.single(shared=all_archaea.env_category.shared, outputdir=data/process)"

mothur "#rarefaction.single(list=data/mothur/all_archaea.filter.unique.precluster.an.list, label=unique-0.03-0.05-0.10-0.20, outputdir=data/process);"

rm data/mothur/*rabund data/mothur/mothur*logfile mothur*logfile
```
