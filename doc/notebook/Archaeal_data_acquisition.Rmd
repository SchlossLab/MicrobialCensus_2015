...
mothur "#set.current(processors=8);
        screen.seqs(fasta=archaea.fasta, taxonomy=archaea.tax, start=3000, end=7800, maxambig=2, maxhomop=8, minlength=900, inputdir=data/mothur/, outputdir=data/mothur/);"
```
...
mothur "#set.dir(input=data/mothur, output=data/mothur);
        ...
        screen.seqs(fasta=current, start=3000, end=7800, maxambig=2, maxhomop=8, minlength=900);
        classify.seqs(fasta=current, reference=archaea.good.fasta, taxonomy=archaea.good.tax, cutoff=80, processors=8)"
```
...
mothur "#set.dir(input=data/mothur, output=data/mothur);
        align.seqs(fasta=data/mothur/emirge.archaea.fasta, reference=data/mothur/archaea.good.fasta);
        screen.seqs(fasta=current, start=3000, end=7800, maxambig=2, maxhomop=8, minlength=900);
        classify.seqs(fasta=current, reference=data/mothur/archaea.good.fasta, taxonomy=data/mothur/archaea.good.tax, cutoff=80, processors=8)"
```
...
cat data/mothur/archaea.good.fasta data/mothur/single_cell.archaea.good.align data/mothur/emirge.archaea.align > data/mothur/all_archaea.align
cat data/mothur/archaea.good.tax data/mothur/single_cell.archaea.good.good.wang.taxonomy data/mothur/emirge.archaea.good.good.wang.taxonomy > data/mothur/all_archaea.taxonomy
