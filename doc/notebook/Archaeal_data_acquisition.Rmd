...
#we'll output the sequence names so the sequences aren't included in the
#rarefaction analysis
write(rownames(spread_sheet_good), file="data/mothur/archaea.sc_emirge.accnos")
```
...
#we'll output the sequence names so the sequences aren't included in the
#rarefaction analysis
write(rownames(archaea_emirge_metadata), file="data/mothur/archaea.sc_emirge.accnos", append=T)
```
