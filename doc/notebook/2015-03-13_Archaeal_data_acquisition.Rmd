...
bad_accnos_data <- read.table(file="data/mothur/single_cell.archaea.bad.accnos", col.names=c("name.accnos", "reason"))
bad_accnos <- bad_accnos_data$name.accnos
spread_sheet_good <- spread_sheet[-c(bad_accnos),]

write.table(spread_sheet_good, file="data/mothur/all_archaea.good.metadata", quote=F, sep="\t", col.names=F, append=T)
```
