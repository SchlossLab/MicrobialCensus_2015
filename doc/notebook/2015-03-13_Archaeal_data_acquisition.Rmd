...
```{r}
bad_accnos_data <- read.table(file="data/process/archaea.bad.accnos", col.names=c("name.accnos", "reason"))
bad_accnos <- bad_accnos_data$name.accnos
metadata_good <- metadata[-c(bad_accnos),]
write.table(metadata_good, file="data/process/all_archaea.good.metadata", quote=F, sep="\t")
```
