...
write.table(metadata_good, file="data/mothur/archaea.good.metadata", quote=F, sep="\t")
```
...
#need actual category from LSU group
spread_sheet$category <- NA
...
spread_sheet_good <- spread_sheet[-which(rownames(spread_sheet) %in% bad_accnos),]

write.table(spread_sheet_good[,colnames(metadata_good)], file="data/mothur/archaea.good.metadata", quote=F, sep="\t", col.names=F, append=T)
```
